...
cur = connection.cursor()
createCartSql = '''CREATE TABLE Collects         
               (UserID                 VARCHAR(100)   ,
                BookID                VARCHAR(100) )'''
cur.execute(createCartSql)
connection.commit()
...
User = pd.read_csv(path, sep=',', on_bad_lines='skip', engine='python', encoding='ISO-8859-1')
...
Book = pd.read_csv(path, sep=None, on_bad_lines='skip',engine='python', encoding='ISO-8859-1')
...
Rating = pd.read_csv(path, sep=None, on_bad_lines='skip',engine='python', encoding='ISO-8859-1')
